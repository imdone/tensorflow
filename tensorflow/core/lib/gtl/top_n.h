...
// time is linear in p.
//
// NOTE (zhifengc): There is a way to do this in O(min(n, p)) storage and O(p) id:2543
// https://github.com/imdone/tensorflow/issues/2542
...
// 
// NOTE (zhifengc): This class should be redesigned to avoid reallocating a id:2780
// https://github.com/imdone/tensorflow/issues/2779
