...
#undef HANDLE_TYPE
 ...
 private:
  // TODO (mrry): Push the templated code down to the raw copying routine. id:2930
  // https://github.com/imdone/tensorflow/issues/2929
  template <class T>
     ...
     public:
      ...
      Status GetNextInternal(IteratorContext* ctx,
          ...
          *end_of_sequence = false;
          for (int i = 0;
            ...
            if (!*end_of_sequence) {
              ...
              // TODO (mrry): Investigate how to hoist this check when we id:2129
              // https://github.com/imdone/tensorflow/issues/2128
        ...
        for (int64 i = 0; i < batch_elements.size(); ++i) {
          ...
          // TODO (mrry): Replace with a memcpy or something more id:1994
          // https://github.com/imdone/tensorflow/issues/1994
