...
//
// NOTE: the operations in this file only are suitable for execution id:2739
// https://github.com/imdone/tensorflow/issues/2738
// on CPUs.
...
class SparseToDense : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* c) override {
    ...
    // TODO (ebrevdo): find a way to avoid this temp allocation. id:3340
    // https://github.com/imdone/tensorflow/issues/3339
