...
// TODO (yangzihao): Remove the dependency of conv_2d.h once we move all id:2521
// https://github.com/imdone/tensorflow/issues/2520
...
void TransposeSimple(const GPUDevice& d, const Tensor& in,
  ...
  // NOTE: host_buf is not allocated by CudaHostAllocator, and id:2763
  // https://github.com/imdone/tensorflow/issues/2762
