...
class FuzzEncodeJpeg : public FuzzSession {
  ...
  void FuzzImpl(const uint8_t* data, size_t size) final {
    ...
    // TODO (dga): kcc@ notes: better to use actual supplied h, w and then id:2454
    // https://github.com/imdone/tensorflow/issues/2453
    ...
    // TODO (dga): Generalize this by borrowing the AsTensor logic id:3196
    // https://github.com/imdone/tensorflow/issues/3195
    ...
    // TODO (b/32704451): Don't just ignore the :: object! tensorflow::Status id:2984
    // https://github.com/imdone/tensorflow/issues/2983
