...
// TODO (yangke): consider moving it to a more private place so that we don't id:3503
// https://github.com/imdone/tensorflow/issues/3502
...
class TensorSliceSet {
 public:
  ...
  // TODO (yangke): avoid unnecessary copying by using a core::RefCounted id:2712
  // https://github.com/imdone/tensorflow/issues/2711
  // pointer.
