...
# TODO (gunan): remove extra flags once sandboxing is enabled for all builds. id:4027
# https://github.com/imdone/tensorflow/issues/4025
...
# TODO (andrewharp): build native libs into AAR directly once id:4352
