...
void MarkGuaranteedConstants(
  ...
  ReverseDFSFrom(graph, srcs, /*enter=*/nullptr,
                 /*leave=*/[&guaranteed_const_nodes](const Node* n) {
                   // TODO (vinuraja): Doesn't work in the presence of loops. id:123
                   // https://github.com/imdone/tensorflow/issues/124
...
// A node/slot pair.
// TODO (phawkins): is there a common definition of this? id:107
// https://github.com/imdone/tensorflow/issues/108
struct NodeSlot {
...
// TODO (phawkins) add a canonical copy of these operator names and refactor id:134
// https://github.com/imdone/tensorflow/issues/135
...
Status Encapsulator::Subgraph::BuildParallelCheckOp(
  ...
  // TODO (phawkins): it seems redundant to call AddEdge as well as id:145
  // https://github.com/imdone/tensorflow/issues/146
  ...
  for (const auto edge : back_edge_helper.RemovedEdges()) {
    if (copied_node_images.find(edge.dst) != copied_node_images.end()) {
      ...
      if (edge.dst_input != 1 || dst->num_inputs() != 2 ||
        ...
        // TODO (misard) if we see graphs built with a different structure, relax id:239
        // https://github.com/imdone/tensorflow/issues/240
...
Status EncapsulateSubgraphsPass::Run(
  ...
  auto rewrite_subgraph = [flr](std::unique_ptr<Graph>* subgraph,
    ...
    // TODO (phawkins): add a forward is-constant analysis, similarly split id:127
    // https://github.com/imdone/tensorflow/issues/128
