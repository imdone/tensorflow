...
def MetadataHasXlaLaunch(run_metadata):
  ...
  # TODO (phawkins): find a less hacky way to test whether a kernel ran. id:136
  # https://github.com/imdone/tensorflow/issues/137
...
class JitLaunchTest(test.TestCase):
  ...
  def testAliasing(self):
    ...
    # TODO (b/36139787): Re-enable this test when noinline works again. id:148
    # https://github.com/imdone/tensorflow/issues/149
  ...
  def testExplicitMarking(self):
    ...
    with ops.Graph().as_default():
      ...
      with session_lib.Session() as sess:
        ...
        # TODO (phawkins): really we would like to test that there were exactly id:159
        # https://github.com/imdone/tensorflow/issues/160
