...
# TODO (mdan): This would be more robust with a CFG. id:1001
# https://github.com/imdone/tensorflow/issues/1002
...
# TODO (mdan): Look into using Python AST's type annotation fields instead. id:732
# https://github.com/imdone/tensorflow/issues/733
...
# TODO (mdan): Remove the duplication between this and activity.py. id:703
# https://github.com/imdone/tensorflow/issues/704
  ...
  def visit_Call(self, node):
    if anno.hasanno(node.func, 'live_val'):
      ...
      if (anno.getanno(node.func, 'live_val') is
        ...
        # TODO (mdan): Should we update references between definition and here? id:541
        # https://github.com/imdone/tensorflow/issues/542
