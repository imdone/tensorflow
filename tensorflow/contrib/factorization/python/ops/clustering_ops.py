  ...
  def _mini_batch_training_op(self, inputs, cluster_idx_list, cluster_centers,
    ...
    for inp, cluster_idx in zip(inputs, cluster_idx_list):
      with ops.colocate_with(inp, ignore_existing=True):
        ...
        # TODO (agarwal): This colocation seems to run into problems. Fix it. id:1136
        # https://github.com/imdone/tensorflow/issues/1137
...
class _InitializeClustersOpFactory(object):
  ...
  # TODO (ccolby): Refactor this class so that kmc2 isn't so much a special case. id:1245
  # https://github.com/imdone/tensorflow/issues/1246
  ...
  def _kmeans_plus_plus(self):
    ...
    # TODO (ands): Use all points. id:841
    # https://github.com/imdone/tensorflow/issues/842
    inp = self._inputs[0]
    if self._distance_metric == COSINE_DISTANCE:
      inp = nn_impl.l2_normalize(inp, dim=1)
  ...
  def _add_new_centers(self):
    ...
    # TODO (ccolby): De-dupe all_centers? id:689
    # https://github.com/imdone/tensorflow/issues/690
    a = state_ops.assign(
