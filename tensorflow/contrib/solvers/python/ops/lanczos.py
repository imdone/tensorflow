...
# TODO (rmlarsen): Add implementation of symmetric Lanczos algorithm. id:2298
# https://github.com/imdone/tensorflow/issues/2297
...
def lanczos_bidiag(operator,
  ...
  # TODO (rmlarsen): This is possibly the slowest implementation of id:1635
  # https://github.com/imdone/tensorflow/issues/1635
  ...
  def stopping_criterion(i, _):
    # TODO (rmlarsen): Stop if an invariant subspace is detected. id:1211
    # https://github.com/imdone/tensorflow/issues/1212
    return i < k
...
# TODO (rmlarsen): Implement C++ ops for handling bidiagonal matrices id:1738
# https://github.com/imdone/tensorflow/issues/1738
