...
# TODO (fkp): very generic code, it should be moved in a more generic place. id:893
# https://github.com/imdone/tensorflow/issues/894
...
# TODO (fkp): very generic code, it should be moved in a more generic place. id:839
# https://github.com/imdone/tensorflow/issues/840
def is_iterable(obj):
...
# TODO (fkp): move this function in tf.Graph? id:747
# https://github.com/imdone/tensorflow/issues/746
