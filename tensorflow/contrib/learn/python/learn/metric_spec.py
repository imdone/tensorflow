...
def _adapt_metric_fn(
  ...
  if labels_arg:
    ...
    if labels_arg == args[0]:
      ...
      def _positional_metric_fn(
          _sentinel=None, labels=None, predictions=None, weights=None):
        _assert_named_args(_sentinel)
        # TODO (ptucker): Should we support metrics that take only labels? id:1394
        # https://github.com/imdone/tensorflow/issues/1395
  ...
  if predictions_arg:
    ...
    def _named_no_labels_metric_fn(
      ...
      # TODO (ptucker): Should we allow weights with no labels? id:1569
      # https://github.com/imdone/tensorflow/issues/1569
      if weights is not None:
        kwargs[weights_arg] = weights
      return metric_fn(**kwargs)
  ...
  def _positional_no_labels_metric_fn(
    ...
    # TODO (ptucker): Should we allow weights with no labels? id:1155
    # https://github.com/imdone/tensorflow/issues/1156
