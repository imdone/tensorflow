...
def _train_internal(graph,
  ...
  with graph.as_default():
    ...
    # TODO (ipolosukhin): Replace all functionality of Supervisor id:1389
    # https://github.com/imdone/tensorflow/issues/1390
  ...
  with session:
    ...
    try:
      ...
      try:
        ...
        # TODO (wicke): This should be handled by Supervisor id:1126
        # https://github.com/imdone/tensorflow/issues/1127
...
def evaluate(graph,
  ...
  with session:
    if not initialized:
      ...
      # TODO (ipolosukhin): This should be failing, but old code relies on that. id:1033
      # https://github.com/imdone/tensorflow/issues/1033
    ...
    eval_results = None
    # TODO (amodei): Fix this to run through the eval set exactly once. id:846
    # https://github.com/imdone/tensorflow/issues/847
    step = 0
    eval_step = None
    feed_dict = None
    ...
    try:
      try:
        while (max_steps is None) or (step < max_steps):
          ...
          # TODO (wicke): We should assert that the global step hasn't changed. id:1364
          # https://github.com/imdone/tensorflow/issues/1365
