...
// NOTE: this interpreter info represents the subset of the id:1077
// https://github.com/imdone/tensorflow/issues/1078
...
TfLiteStatus Interpreter::GetExecutionPlan(TfLiteIntArray** execution_plan) {
  // TODO (aselle): Do not make a copy here id:910
  // https://github.com/imdone/tensorflow/issues/911
...
TfLiteStatus Interpreter::BytesRequired(TfLiteType type, const int* dims,
  ...
  // TODO (aselle): Check for overflow here using overflow.h in TensorFlow id:1479
  // https://github.com/imdone/tensorflow/issues/1480
...
TfLiteStatus Interpreter::AddNodeWithParameters(
  ...
  // NOTE , here we are not using move semantics yet, since our internal id:1729
  // https://github.com/imdone/tensorflow/issues/1729
  ...
  // TODO (ycling): Filling `custom_initial_data` and `custom_initial_data_size` id:1350
  // https://github.com/imdone/tensorflow/issues/1351
...
TfLiteStatus Interpreter::ResizeInputTensor(int tensor_index,
  ...
  // TODO (aselle): All bounds checks can be implemented as one-sided bounds id:1082
  // https://github.com/imdone/tensorflow/issues/1083
...
TfLiteStatus Interpreter::Invoke() {
  ...
  if (nnapi_delegate_) {
    if (next_execution_plan_index_to_prepare_ == execution_plan_.size()) {
      ...
      // TODO (aselle): In the future, we would like this to be an id:914
      // https://github.com/imdone/tensorflow/issues/915
  ...
  // called.
  // TODO (b/71913981): we should force recalculation in the presence of dynamic id:1481
  // https://github.com/imdone/tensorflow/issues/1482
  ...
  for (int execution_plan_index = 0;
    ...
    // TODO (ycling): This is an extra loop through inputs to check if the data id:1734
    // https://github.com/imdone/tensorflow/issues/1734
...
void Interpreter::UseNNAPI(bool enable) {
  // TODO (aselle): This is a workaround for finding if NNAPI exists. id:1354
  // https://github.com/imdone/tensorflow/issues/1355
...
void Interpreter::SetNumThreads(int num_threads) {
  ...
  // TODO (ahentz): find a way to avoid this. It causes gemmlowp and eigen to id:1086
  // https://github.com/imdone/tensorflow/issues/1087
...
TfLiteStatus Interpreter::ModifyGraphWithDelegate(TfLiteDelegate* delegate,
  ...
  // TODO (aselle): Consider if it is worth storing pointers to delegates. id:917
  // https://github.com/imdone/tensorflow/issues/918
