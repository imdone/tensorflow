...
# TODO (b/35290280): Import in `../../__init__.py` after adding unit-tests. id:665
# https://github.com/imdone/tensorflow/issues/666
...
def _kl_brute_force(a, b, name=None):
  ...
  # TODO (b/35041439): See also b/35040945. Remove this function once LinOp id:664
  # https://github.com/imdone/tensorflow/issues/665
