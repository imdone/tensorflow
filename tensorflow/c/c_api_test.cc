...
TEST(CAPI, LibraryLoadFunctions) {
  // TODO (b/73318067): Fix linking for the GPU test generated by the id:45
  // https://github.com/imdone/tensorflow/issues/46
...
// TODO (ashankar): Use gmock matchers instead? id:28
// https://github.com/imdone/tensorflow/issues/29
...
TEST(TestApiDef, TestCreateApiDef) {
  // TODO (b/73318067): Fix linking for the GPU test generated by the id:29
  // https://github.com/imdone/tensorflow/issues/30
  // tf_cuda_cc_test() bazel rule and remove the next line.
  if (!GPUDeviceName().empty()) return;
...
TEST(TestApiDef, TestCreateApiDefWithOverwrites) {
  // TODO (b/73318067): Fix linking for the GPU test generated by the id:30
  // https://github.com/imdone/tensorflow/issues/31
  // tf_cuda_cc_test() bazel rule and remove the next line.
  if (!GPUDeviceName().empty()) return;
...
// TODO (josh11b): Test: id:43
// https://github.com/imdone/tensorflow/issues/44
