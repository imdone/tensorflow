...
// following processing easier. TODO (iga): Simplify this nested structure. id:41
// https://github.com/imdone/tensorflow/issues/42
...
void TF_GraphCopyFunction(TF_Graph* g, const TF_Function* func,
  ...
  // TODO (iga): Add AddFunctionDef() and AddGradientDef() methods to graph id:25
  // https://github.com/imdone/tensorflow/issues/26
