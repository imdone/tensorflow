...
// TODO (skyewm): make sure this is unique among existing frame names id:80
// https://github.com/imdone/tensorflow/issues/81
...
Status AddWhileLoopGradient(WhileContext* while_ctx, const Scope& scope,
  ...
  // TODO (skyewm): can we combine the backprop loop counter and main gradient id:79
  // https://github.com/imdone/tensorflow/issues/80
