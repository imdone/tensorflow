...
// TODO (andydavis) Test gradient function against numeric gradients output. id:85
// https://github.com/imdone/tensorflow/issues/86
// TODO (andydavis) As more gradients are added move common test functions id:83
// https://github.com/imdone/tensorflow/issues/84
...
TEST_F(CWiseUnaryGradTest, Asin_Complex) {
  ...
  // TODO (kbsriram) id:121
  // https://github.com/imdone/tensorflow/issues/122
...
TEST_F(CWiseUnaryGradTest, Acos_Complex) {
  ...
  // TODO (kbsriram) id:219
  // https://github.com/imdone/tensorflow/issues/220
...
TEST_F(CWiseUnaryGradTest, Tan_Complex) {
  ...
  // TODO (kbsriram) id:101
  // https://github.com/imdone/tensorflow/issues/102
...
TEST_F(CWiseUnaryGradTest, Atan_Complex) {
  ...
  // TODO (kbsriram) id:87
  // https://github.com/imdone/tensorflow/issues/88
...
TEST_F(CWiseUnaryGradTest, Lgamma_Complex) {
  ...
  // TODO (kbsriram) id:86
  // https://github.com/imdone/tensorflow/issues/87
...
TEST_F(CWiseUnaryGradTest, Erf_Complex) {
  ...
  // TODO (kbsriram) id:122
  // https://github.com/imdone/tensorflow/issues/123
