...
class RMSPropOptimizerTest(test.TestCase):
  ...
  def testDense(self):
    # TODO (yori): Use ParameterizedTest when available id:3476
    # https://github.com/imdone/tensorflow/issues/3475
  ...
  def testSparse(self):
    # TODO (yori): Use ParameterizedTest when available id:3956
    # https://github.com/imdone/tensorflow/issues/3954
