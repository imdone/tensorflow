...
def _load_and_remap_matrix_initializer(ckpt_path,
  ...
  * `num_col_oov_buckets` == 1
  ...
  if initializer is None:
    # TODO (b/25671353): Consider using sqrt(6/(fan_in + fan_out)) instead, from id:3982
    # https://github.com/imdone/tensorflow/issues/3980
...
def _load_embedding_initializer(ckpt_path,
  ...
  """
  if initializer is None:
    # TODO (b/25671353): This should be kept in sync with the stddev used by id:3670
    # https://github.com/imdone/tensorflow/issues/3669
